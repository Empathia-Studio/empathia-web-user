...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white dark:bg-black/80 border border-gray-200 dark:border-white/10 rounded-2xl p-8 relative z-10">
            ...
            <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center">
              <div className="w-12 h-12 bg-background rounded-full relative">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-sm text-gray-700 dark:text-white/80 mb-2">
                            Full Name
                        </label>
                    ...
                    <div>
                        <label htmlFor="confirmPassword" className="block text-sm text-gray-700 dark:text-white/80 mb-2">
                            Confirm Password
                        </label>
                        <div className="relative">
                            <Input
                    ...
                    <Button type="submit" className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 h-12 mt-6 mb-6">
                        Create Account
                    </Button>
                </form>
    
                <div className="text-center">
                    <Link href="/auth/login" className="text-purple-700 dark:text-purple-300 hover:underline text-sm">Already have an account? Sign in here.</Link>
                </div>
            </div>
        </div>
    )
